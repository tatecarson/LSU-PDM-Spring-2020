...
- **2-28-20** - Adding effects and intro to synthesis - [slides](https://lsu-pdm-2019.netlify.com/week_1_th/_static/#/), [textbook](https://pdm.lsupathways.org/3_audio/1_sampler/2_lesson_2/)
